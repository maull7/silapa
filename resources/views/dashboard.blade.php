...
<head>
    ...
    <style>
        ...
        .user-info {
            ...
            width: 100%;
            margin-top: 0.5rem;
             background: linear-gradient(135deg, #d6b71a 0%, #c99700 100%);
             color: #333;
            border-radius: 10px;
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link position-relative text-warning" data-toggle="dropdown" href="#"
                    aria-expanded="false">
                    <i class="fas fa-bell fa-lg"></i>
                    @if ($notifCount > 0)
                        <span class="badge badge-warning navbar-badge position-absolute" style="top: 0; right: 0;">
                            {{ $notifCount }}
                        </span>
                    @endif
                </a>
                <div class="dropdown-menu dropdown-menu-right shadow notif-dropdown">
                    <span class="dropdown-header text-warning font-weight-bold">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="{{ route('notif.read') }}" class="dropdown-item dropdown-footer text-warning">Lihat
        ...
        <div class="brand-link">
            <a href="#" class="brand">
                ...
                <div class="brand-text-container">
                    <span class="brand-text">SILAPA</span>
                    <span class="brand-subtext">Sistem Layanan Pencairan Anggaran</span>
                </div>
            </a>
            <div class="user-info">
                ...
                <div class="user-details">
                    ...
                    <span class="user-role">
                        @php
                            $userId = auth()->user()->id_jabatan;
                            $jabatan = DB::table('master_jabatan')->where('id', $userId)->first();
                                    ...
                                    <i class="fas fa-tags position-relative">
                                        @if (isset($PengajuCount) && $PengajuCount > 0)
                                            <span class="position-absolute"
                                                style="top: -3px; right: -6px; width: 8px; height: 8px; background-color: yellow; border-radius: 50%; border: 1px solid white;">
                                            </span>
                                        @endif
                                    </i>
                                    <p>
                                    ...
                                    <li class="nav-item">
                                        <a href="/pengajuan"
                                            ...
                                            <p>
                                                Permohonan & Riwayat
                                                @if ($PengajuCount > 0)
                                                    <span class="badge badge-warning ml-1">{{ $PengajuCount }}</span>
                                                @endif
                                            </p>
                                        </a>
                                    </li>
                                ...
                                <li class="nav-item">
                                    <a href="/verifikasi-pengajuan"
                                        ...
                                        <p>
                                            ...
                                            @if ($verifyCount > 0)
                                                <span class="badge badge-warning ml-1">{{ $verifyCount }}</span>
                                            @endif
                                        </p>
                                    </a>
                                </li>
                                ...
                                <ul id="masterMenu" class="collapse nav flex-column">
                                    <li class="nav-item">
                                        <a href="/master_jabatan"
                                            class="nav-link {{ request()->is('master_jabatan*') ? 'active' : '' }}">
                                            <p>
                                                <i class="fas fa-user-shield"></i> Master Jabatan
                                            </p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/master_user"
                                            ...
                                            <p>
                                                <i class="fas fa-user-shield"></i> Master Admin
                                    ...
                                    <li class="nav-item">
                                        <a href="/master_pengguna"
                                            class="nav-link {{ request()->is('master_pengguna*') ? 'active' : '' }}">
                                            <p>
                                                <i class="fas fa-user"></i> Master Pengguna
